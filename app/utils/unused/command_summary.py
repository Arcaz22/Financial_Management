    ...
    try:
        ...
        if text == "/summary":
            ...
            if result["status"] == "success":
                ...
                return (
                    f"❌ Maaf, terjadi kesalahan saat membuat ringkasan: {result['message']}",
                    None,
                )

        return (
            "Maaf, saya tidak dapat memproses permintaan ringkasan Anda. Silakan coba lagi dengan mengetik /summary",
            None,
        )
        ...
        return (
            f"❌ Terjadi kesalahan saat membuat ringkasan keuangan: {str(e)}. Silakan coba lagi nanti.",
            None,
        )
